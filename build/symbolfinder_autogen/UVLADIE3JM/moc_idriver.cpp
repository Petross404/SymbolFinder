/****************************************************************************
** Meta object code from reading C++ file 'idriver.hpp'
**
...
#include "../../../src/idriver.hpp"
#if !defined( Q_MOC_OUTPUT_REVISION )
#	error "The header file 'idriver.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL( idx, ofs, len )                                         \
	Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                \
		len,                                                            \
		qptrdiff( offsetof( qt_meta_stringdata_IDriver_t, stringdata0 ) \
...
static const qt_meta_stringdata_IDriver_t qt_meta_stringdata_IDriver = {
	{
		...
		QT_MOC_LITERAL( 1, 8, 16 ),    // "startedSearchFor"
		QT_MOC_LITERAL( 2, 25, 0 ),    // ""
		QT_MOC_LITERAL( 3, 26, 6 )     // "symbol"

	},
	"IDriver\0startedSearchFor\0\0symbol" };
...
void IDriver::qt_static_metacall( QObject *_o, QMetaObject::Call _c, int _id, void **_a )
{
	...
	{
		auto *_t = static_cast<IDriver *>( _o );
		Q_UNUSED( _t )
		switch ( _id )
		{
			case 0:
	...
	else if ( _c == QMetaObject::IndexOfMethod )
	{
		...
		{
			using _t = void ( IDriver::* )( const QString & );
			if ( *reinterpret_cast<_t *>( _a[1] )
			     == static_cast<_t>( &IDriver::startedSearchFor ) )
			{
				*result = 0;
				return;
			}
...
QT_INIT_METAOBJECT const QMetaObject IDriver::staticMetaObject = {
	{ QMetaObject::SuperData::link<QProcess::staticMetaObject>(),
	  qt_meta_stringdata_IDriver.data,
	  qt_meta_data_IDriver,
	  qt_static_metacall,
	  nullptr,
	  nullptr } };
...
// SIGNAL 0
void IDriver::startedSearchFor( const QString &_t1 )
{
	void *_a[] = { nullptr,
