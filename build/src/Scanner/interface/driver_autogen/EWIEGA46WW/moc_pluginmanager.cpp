...
#include "../../../../../../src/Scanner/interface/pluginmanager.hpp"
...
#define QT_MOC_LITERAL( idx, ofs, len )                                               \
	Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                      \
		len,                                                                  \
		qptrdiff( offsetof( qt_meta_stringdata_PluginManager_t, stringdata0 ) \
...
void *PluginManager::qt_metacast( const char *_clname )
{
	...
	if ( !strcmp( _clname, "DriverFactory" ) )
		return static_cast<DriverFactory *>( this );
