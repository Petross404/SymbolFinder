...
#	define COMPILER_VERSION_MAJOR \
		HEX( __CODEGEARC_VERSION__ >> 24 & 0x00FF )
#	define COMPILER_VERSION_MINOR \
		HEX( __CODEGEARC_VERSION__ >> 16 & 0x00FF )
...
#	define COMPILER_VERSION_MINOR \
		DEC( __TI_COMPILER_VERSION__ / 1000 % 1000 )
...
#		define COMPILER_VERSION_MINOR \
			DEC( __GHS_VERSION_NUMBER / 10 % 10 )
...
#		define COMPILER_VERSION_MINOR \
			DEC( __ARMCC_VERSION / 10000 % 100 )
#		define COMPILER_VERSION_PATCH DEC( __ARMCC_VERSION % 10000 )
#	else
/* __ARMCC_VERSION = VRPPPP */
#		define COMPILER_VERSION_MAJOR DEC( __ARMCC_VERSION / 100000 )
#		define COMPILER_VERSION_MINOR \
			DEC( __ARMCC_VERSION / 10000 % 10 )
#		define COMPILER_VERSION_PATCH DEC( __ARMCC_VERSION % 10000 )
#	endif
...
#	define COMPILER_VERSION_MINOR \
		DEC( __ARMCOMPILER_VERSION / 10000 % 100 )
...
#			define COMPILER_VERSION_PATCH \
				DEC( _MSC_FULL_VER % 100000 )
#		else
/* _MSC_FULL_VER = VVRRPPPP */
#			define COMPILER_VERSION_PATCH \
				DEC( _MSC_FULL_VER % 10000 )
#		endif
#	endif
...
#		define COMPILER_VERSION_MINOR \
			HEX( __VISUALDSPVERSION__ >> 16 & 0xFF )
#		define COMPILER_VERSION_PATCH \
			HEX( __VISUALDSPVERSION__ >> 8 & 0xFF )
#	endif
